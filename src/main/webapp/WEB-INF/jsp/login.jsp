...
<body
	style="background-image: url(https://pm-image.s3.amazonaws.com/pension-fund.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
	<header>
