...
<body
	style="background-image: url(https://pm-image.s3.amazonaws.com/ERP_Implemnetation_failure.jpg); background-size: cover; background-repeat: no-repeat; background-position: cover;">
	<header>
